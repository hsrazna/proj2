                                ...
                                <form role="search" method="get" id="searchform" class="searchform" action="/advanced-search/">
                                    <div class="ls-form-owl">
                                        ...
                                        <div class="col-md-4 col-sm-12 az-sm-margin10" style="height: 335px;">
                                            ...
                                            <div class="phuket-map-inner" style="height: 335px;">
                                            <div class="newmapLocations">
                                            
                                            <div class="phuket-district" style="height: 0px; position: absolute; left: 40px; top: 51px">
                                            <input id="Mai Khao" title="Mai Khao" type="checkbox" class="map-checkbox area-MAI" name="area[]" value="Mai Khao"/>
                                            <label for="Mai Khao" class="MAI" title="">Mai Khao</label>
                                            </div>
                                            <div class="phuket-district" style="height: 0px; position: absolute; left: 37px; top: 84px">
                                            <input id="Nai Yang" title="Nai Yang" type="checkbox" class="map-checkbox area-NYG" name="area[]" value="Nai Yang"/>
                                            <label for="Nai Yang" class="NYG" title="">Nai Yang</label>
                                            </div>
                                            <div class="phuket-district" style="height: 0px; position: absolute; left: 21px; top: 107px">
                                            <input id="Nai Thon" title="Nai Thon" type="checkbox" class="map-checkbox area-NAT" name="area[]" value="Nai Thon"/>
                                            <label for="Nai Thon" class="NAT" title="">Nai Thon</label>
                                            </div>
                                            <div class="phuket-district" style="height: 0px; position: absolute; left: 26px; top: 125px">
                                            <input id="Layan" title="Layan" type="checkbox" class="map-checkbox area-LAY" name="area[]" value="Layan"/>
                                            <label for="Layan" class="LAY" title="">Layan</label>
                                            </div>
                                            <div class="phuket-district" style="height: 0px; position: absolute; left: 34px; top: 149px">
                                            <input id="Bang Tao" title="Bang Tao" type="checkbox" class="map-checkbox area-BAN" name="area[]" value="Bang Tao"/>
                                            <label for="Bang Tao" class="BAN" title="">Bang Tao</label>
                                            </div>
                                            <div class="phuket-district" style="height: 0px; position: absolute; left: 23px; top: 166px">
                                            <input id="Surin" title="Surin" type="checkbox" class="map-checkbox area-SUR" name="area[]" value="Surin"/>
                                            <label for="Surin" class="SUR" title="">Surin</label>
                                            </div>
                                            <div class="phuket-district" style="height: 0px; position: absolute; left: 23px; top: 188px">
                                            <input id="Kamala" title="Kamala" type="checkbox" class="map-checkbox area-KAM" name="area[]" value="Kamala"/>
                                            <label for="Kamala" class="KAM" title="">Kamala</label>
                                            </div>
                                            <div class="phuket-district" style="height: 0px; position: absolute; left: 36px; top: 229px">
                                            <input id="Patong" title="Patong" type="checkbox" class="map-checkbox area-PAT" name="area[]" value="Patong"/>
                                            <label for="Patong" class="PAT" title="">Patong</label>
                                            </div>
                                            <div class="phuket-district" style="height: 0px; position: absolute; left: 36px; top: 269px">
                                            <input id="Karon" title="Karon" type="checkbox" class="map-checkbox area-KAR" name="area[]" value="Karon"/>
                                            <label for="Karon" class="KAR" title="">Karon</label>
                                            </div>
                                            <div class="phuket-district" style="height: 0px; position: absolute; left: 38px; top: 291px">
                                            <input id="Kata" title="Kata" type="checkbox" class="map-checkbox area-KAT" name="area[]" value="Kata"/>
                                            <label for="Kata" class="KAT" title="">Kata</label>
                                            </div>
                                            <div class="phuket-district" style="height: 0px; position: absolute; left: 18px; top: 311px">
                                            <input id="Kata Noi" title="Kata Noi" type="checkbox" class="map-checkbox area-KAN" name="area[]" value="Kata Noi"/>
                                            <label for="Kata Noi" class="KAN" title="">Kata Noi</label>
                                            </div>
                                            <!-- Ката Ной -->
                                            <div class="phuket-district" style="height: 0px; position: absolute; left: 42px; top: 332px">
                                            <input id="Nai Harn" title="Nai Harn" type="checkbox" class="map-checkbox area-NAI" name="area[]" value="13"/>
                                            <label for="Nai Harn" class="NAI" title="">Nai Harn</label>
                                            </div>
                                            <div class="phuket-district" style="height: 0px; position: absolute; left: 67px; top: 219px">
                                            <input id="Kathu" title="Kathu" type="checkbox" class="map-checkbox area-KTH" name="area[]" value="Kathu"/>
                                            <label for="Kathu" class="KTH" title="">Kathu</label>
                                            </div>
                                            <div class="phuket-district" style="height: 0px; position: absolute; left: 101px; top: 233px">
                                            <input id="Phuket City" title="Phuket City" type="checkbox" class="map-checkbox area-PHU" name="area[]" value="Phuket City"/>
                                            <label for="Phuket City" class="PHU" title="">Phuket City</label>
                                            </div>
                                            <div class="phuket-district" style="height: 0px; position: absolute; left: 54px; top: 316px">
                                            <input id="Rawai" title="Rawai" type="checkbox" class="map-checkbox area-RAW" name="area[]" value="4"/>
                                            <label for="Rawai" class="RAW" title="">Rawai</label>
                                            </div>
                                            <div class="phuket-district" style="height: 0px; position: absolute; left: 108px; top: 283px">
                                            <input id="Panwa" title="Panwa" type="checkbox" class="map-checkbox area-PAN" name="area[]" value="Panwa"/>
                                            <label for="Panwa" class="PAN" title="">Panwa</label>
                                            </div>
                                            <div class="phuket-district" style="height: 0px; position: absolute; left: 129px; top: 94px">
                                            <input id="East" title="East" type="checkbox" class="map-checkbox area-EAS" name="area[]" value="East"/>
                                            <label for="East" class="EAS" title="">East</label>
                                            </div>
                                            <div class="phuket-district" style="height: 0px; position: absolute; left: 63px; top: 126px">
                                            <input id="Talang" title="Talang" type="checkbox" class="map-checkbox area-TAL" name="area[]" value="Talang"/>
                                            <label for="Talang" class="TAL" title="">Talang</label>
                                            </div>
                                            <div class="phuket-district" style="height: 0px; position: absolute; left: 60px; top: 159px">
                                            <input id="Cherng Talay" title="Cherng Talay" type="checkbox" class="map-checkbox area-CHE" name="area[]" value="Cherng Talay"/>
                                            <label for="Cherng Talay" class="CHE" title="">Cherng Talay</label>
                                            </div>
                                            <div class="phuket-district" style="height: 0px; position: absolute; left: 66px; top: 271px">
                                            <input id="Chalong" title="Chalong" type="checkbox" class="map-checkbox area-CHA" name="area[]" value="Chalong"/>
                                            <label for="Chalong" class="CHA" title="">Chalong</label>
                                            </div>
                                            <div class="phuket-district" style="height: 0px; position: absolute; left: 34px; top: 4px">
                                            <input id="Phang Nga" title="Phang Nga" type="checkbox" class="map-checkbox area-PHA" name="area[]" value="Phang Nga"/>
                                            <label for="Phang Nga" class="PHA" title="">Phang Nga</label>
                                            </div>
                                            </div>
                                            </div>
                                            </div>
