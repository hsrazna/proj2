...
class WPClickToTweetAdmin extends WPInboundRocketAdmin {
	...
	public function ir_ctt_input_fields ()
	{
		...
		<tr valign="top">
			...
			<td><?php _e('To use, simply include the Click to Tweet code in your post. Place your message within the parentheses. Tweet length will be automatically truncated to 120 characters.','inbound-rocket');?>  <pre>[clicktotweet]<?php _e('This is a tweet. It is only a tweet.','inbound-rocket');?>[/clicktotweet]</pre></td>
		</tr>
		<tr valign="top">
