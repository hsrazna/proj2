...
class WPWelcomeBarAdmin extends WPInboundRocketAdmin {
	...
	function ir_wb_input_fields () {
		...
		$ir_wb_color = isset($this->options['ir_wb_color']) ? esc_attr( $this->options['ir_wb_color'] ) : 'red';
		...
		?>     
				<tr>
					<th><label for="ir_ss_twitter_username"><?php _e('Call to Action (Desktop)','inbound-rocket');?>:</label></th>
				...
				<tr>
					<th><label for="ir_ss_twitter_username"><?php _e('Call to Action (Mobile)','inbound-rocket');?>:</label></th>
				...
				<tr>
					<th><label for="ir_ss_twitter_username"><?php _e('Email Address Placeholder Text','inbound-rocket');?>:</label></th>
				...
				<tr>
					<th><label for="ir_ss_twitter_username"><?php _e('Button text','inbound-rocket');?>:</label></th>
					<td><input type="text" name="inboundrocket_wb_options[ir_wb_button_text]" id="ir_wb_button_text" value="<?=$ir_wb_button_text;?>">
					<br /><span class="description"><?php _e('Customise the message and call to action for visitors on a desktop browser.','inbound-rocket');?></span></td>
				</tr>
				<tr>
					<th><label for="ir_ss_twitter_username"><?php _e('Success text','inbound-rocket');?>:</label></th>
				...
				<tr>
					<th><h3><?php _e('Behavior','inbound-rocket');?></h3></th>
				</tr>
				...
				-->
				<tr>
					<th><label for="ir_wb_color"><?php _e('Pick a color style','inbound-rocket');?>:</label></th>
					<td>
						<table>
							<tr>
				...
				<tr>
					<th><label for="ir_wb_hide"><?php _e('Auto-hide welcome bar on submission','inbound-rocket');?>:</label></th>
					<td>
						<input type="checkbox" name="inboundrocket_wb_options[ir_wb_hide]" id="ir_wb_hide" value="1" <?php checked('1', $ir_wb_hide); ?> />
					</td>
				</tr>
				<tr>
					<th><label for="ir_wb_show_on"><?php _e('Show Welcome Bar on','inbound-rocket');?>:</label></th>
					<td>
