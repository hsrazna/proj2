					...
					echo '<div class="inboundrocket-meta-section">';
						echo '<table class="inboundrocket-meta-table">';
							echo '<tbody>';
								echo '<tr>';
									echo '<td>'; 
										echo '<img class="contact-header-avatar inboundrocket-dynamic-avatar_'. esc_attr($lead_id) .'" src="http://www.gravatar.com/avatar/' . $gravatar_hash .'" alt="Avatar" />';
									echo '</td>';
									echo '<td>';
										echo '<table>';
											echo '<tr>';
								...
								echo '<tr>';
									...
									echo '<td><strong>' . __( 'Location', 'inbound-rocket' ) .':</strong><br />' . esc_html($lead_city) . ', ' .esc_html($lead_state). ' ' . esc_html($lead_country) . '</td>';
