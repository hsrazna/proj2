...
class WPSelectionSharer extends WPInboundRocket {
	...
	{	
		...
		$this->inboundrocket_ss_styles();
	 	if (INBOUNDROCKET_ENABLE_DEBUG) { wp_enqueue_script( "inboundrocket_ss_script", INBOUNDROCKET_SELECTION_SHARER_PATH . '/js/selection-sharer.js', array( 'jquery' ) );}
    ...
    {
		if (INBOUNDROCKET_ENABLE_DEBUG) { wp_register_style('inboundrocket_ss_style', INBOUNDROCKET_SELECTION_SHARER_PATH . '/css/selection-sharer.css', false, '0.1');}
