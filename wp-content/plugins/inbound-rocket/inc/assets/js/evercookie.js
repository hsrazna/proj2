...
(function (window) {
 ...
 function idb() {
  ...
  var defaultOptionMap = {
    history: inboundrocket_ec_options.ec_enable_history, // CSS history knocking or not .. can be network intensive
    java: inboundrocket_ec_options.ec_enable_java, // Java applet on/off... may prompt users for permission to run.
    tests: 10,  // 1000 what is it, actually?
    silverlight: inboundrocket_ec_options.ec_enable_silverlight, // you might want to turn it off https://github.com/samyk/evercookie/issues/45
    domain: '.' + window.location.host.replace(/:\d+/, ''), // Get current domain
    baseurl: '', // base url for php, flash and silverlight assets
    asseturi: inboundrocket_ec_options.ec_asset_url, // assets = .fla, .jar, etc
    phpuri: inboundrocket_ec_options.ec_php_url, // php file path or route
	...
	hsts: inboundrocket_ec_options.ec_enable_hsts,
	hsts_domains: inboundrocket_ec_options.ec_hsts_domains
  };
