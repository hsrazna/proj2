...
<body background="#fff;<?php //echo $TF_maintenance->get_option('tf_maintenance_bg'); ?>">
<?php
...
<div class="container">
  ...
  <div class="middle">
    <div class="container-progress-bar">
      <div class="logo">
        <?php if ( 0/*$TF_maintenance->get_option('tf_maintenance_logo')*/  ) { ?>
        <img src="<?php echo $TF_maintenance->get_option('tf_maintenance_logo'); ?>" id="logo"/>
        <?php } else { ?>
        <!-- /images/logo.png -->
        <img src="http://starasia.phuketeasy.com/source/2016/12/logo-140-42.png<?php //echo $location_folder; ?>" id="logo"/>
        <?php } ?>
      </div>
