...
class Affiliate_Links_Settings {
	...
	function add_action_links( $links ) {
		...
		$links[] = '<a href="http://codecanyon.net/item/affiliate-links-wordpress-plugin-for-link-shortening-and-masking/16917669?ref=teamdev-ltd" target="_blank">' . __( 'Go Premium', 'affiliate-links' ) . '</a>';
